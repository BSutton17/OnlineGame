...
const Characters = () => {
  ...
  return (
    <div id="characters">
      ...
      <p><strong>Range:</strong> Melee</p>
      <p><strong>Ability:</strong> Rise (Active) The number of fallen dead allies are resurrected as the undead <GiRaiseSkeleton />, the undead can only move one square, but don’t count towards your movement!</p>
